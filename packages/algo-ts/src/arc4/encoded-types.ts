 ...
 */
abstract class Arc4ArrayBase<TItem> extends ARC4Encoded {
 ...
 */
export class StaticArray<TItem, TLength extends number> extends Arc4ArrayBase<TItem> {
  /**
 ...
 * @typeParam TItem The type of a single item in the array
 */
export class DynamicArray<TItem> extends Arc4ArrayBase<TItem> {
  /**
