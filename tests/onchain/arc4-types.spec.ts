...
describe('arc4-types', () => {
  const test = createBaseTestFixture({ paths: 'tests/approvals/arc4-types.algo.ts', contracts: ['Arc4TypesTestContract'] })
...
describe('arc4-struct', () => {
  const test = createArc4TestFixture({ paths: 'tests/approvals/arc4-struct.algo.ts', contracts: { StructDemo: {} } })
...
describe('arc4-encode-decode', () => {
  const test = createArc4TestFixture({ paths: 'tests/approvals/arc4-encode-decode.algo.ts', contracts: { Arc4EncodeDecode: {} } })
