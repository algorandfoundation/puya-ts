...
describe('abi-decorators', () => {
  ...
  test('methods can be called', async ({ appClientAbiDecorators: appClient }) => {
  ...
  test('overloaded methods can be called', async ({ appClientOverloadedMethods }) => {
  ...
  test('overridden methods work as expected', async ({ appClientBaseAbi, appClientSubAbi, appClientSubAbi2 }) => {
