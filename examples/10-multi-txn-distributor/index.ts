/**
 * Example 10: Multi-Txn Distributor — Deployment & Test Script
 *
...
async function main() {
  printHeader('Example 10 — Multi-Txn Distributor')

  // Step 1: Compile the contract
  printStep(1, 'Compiling contract...')
  compileContract('10-multi-txn-distributor')
  printSuccess('Contract compiled')

  // Step 2: Load app spec
  printStep(2, 'Loading app spec...')
  const appSpec = loadAppSpec('10-multi-txn-distributor/out', 'MultiTxnDistributor')
