/**
 * Example 09: Array Playground — Deployment & Test Script
 *
...
async function main() {
  printHeader('Example 09 — Array Playground')

  // Step 1: Compile the contract
  printStep(1, 'Compiling contract...')
  compileContract('09-array-playground')
  printSuccess('Contract compiled')

  // Step 2: Load app spec
  printStep(2, 'Loading app spec...')
  const appSpec = loadAppSpec('09-array-playground/out', 'ArrayPlayground')
