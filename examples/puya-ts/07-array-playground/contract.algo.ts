...
export class ArrayPlayground extends Contract {
   ...
   * @returns sum of modified array elements
   */
  ...
  /**
   * Demonstrate FixedArray — construction, indexing, .length, .entries().
   * @param x - first element
   * @param y - second element
   * @returns sum of all fixed array elements
   */
  ...
  /**
   * Demonstrate ReferenceArray — dynamic sizing with .push(), .pop(), .at(), .length, for...of.
   * @param n - number of elements to add
   * @returns sum of remaining elements after pop
   */
   ...
   * @param a - first element
   * @param b - second element
   * @returns original first element, proving clone independence
   */
   ...
   * @returns sum from the stepped urange iteration
   */
