...
export class GreeterFactory extends Contract {
   ...
   * @returns the deployed child Application
   */
   ...
   * @param app - the child Application to call
   * @param name - the name to pass to greet()
   * @returns the greeting string from the child
   */
   ...
   * @param app - the child Application to call
   * @param name - the name to pass to greet()
   * @returns the greeting string decoded from the inner transaction
   */
   ...
   * @param app - the child Application to delete
   */
   ...
   * @returns the extraProgramPages value from the compiled contract
   */
  @readonly
