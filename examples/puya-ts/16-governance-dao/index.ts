/**
 * Example 16: Governance DAO — Deployment & Test Script
 *
...
async function main() {
  printHeader('Example 16 — Governance DAO')

  // Step 1: Compile the contract
  printStep(1, 'Compiling contract...')
  compileContract('16-governance-dao')
  printSuccess('Contract compiled')

  // Step 2: Load app spec
  printStep(2, 'Loading app spec...')
  const appSpec = loadAppSpec('16-governance-dao/out', 'GovernanceDao')
