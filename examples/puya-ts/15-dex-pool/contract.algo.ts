...
export class DexPool extends Contract {
   ...
   * @param assetA - First asset in the trading pair (must have lower ID)
   * @param assetB - Second asset in the trading pair (must have higher ID)
   * @param seed - Payment transaction to fund the contract's min-balance
   * @returns The newly created pool token asset ID
   */
   ...
   * @param depositA - Asset transfer transaction depositing asset A
   * @param depositB - Asset transfer transaction depositing asset B
   ...
   * @param poolDeposit - Asset transfer transaction returning pool tokens
   */
   ...
   * @param deposit - Asset transfer transaction depositing the input asset
   * @returns The amount of the output asset sent to the swapper
   */
   ...
   * @returns The current pool state with reserves and total liquidity
   */
  @readonly
