/**
 * Example 05: Type Explorer — Deployment & Test Script
 *
...
async function main() {
  printHeader('Example 05 — Type Explorer')

  // Step 1: Compile the contract
  printStep(1, 'Compiling contract...')
  compileContract('05-type-explorer')
  printSuccess('Contract compiled')

  // Step 2: Load app spec
  printStep(2, 'Loading app spec...')
  const appSpec = loadAppSpec('05-type-explorer/out', 'TypeExplorer')
