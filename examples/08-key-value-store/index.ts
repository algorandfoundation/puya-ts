/**
 * Example 08: Key-Value Store — Deployment & Test Script
 *
...
async function main() {
  printHeader('Example 08 — Key-Value Store')

  // Step 1: Compile the contract
  printStep(1, 'Compiling contract...')
  compileContract('08-key-value-store')
  printSuccess('Contract compiled')

  // Step 2: Load app spec
  printStep(2, 'Loading app spec...')
  const appSpec = loadAppSpec('08-key-value-store/out', 'KeyValueStore')
