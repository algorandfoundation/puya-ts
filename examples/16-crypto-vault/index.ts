/**
 * Example 16: Crypto Vault — Deployment & Test Script
 *
...
async function main() {
  printHeader('Example 16 — Crypto Vault')

  // Step 1: Compile the contract
  printStep(1, 'Compiling contract...')
  compileContract('16-crypto-vault')
  printSuccess('Contract compiled')

  // Step 2: Load app spec
  printStep(2, 'Loading app spec...')
  const appSpec = loadAppSpec('16-crypto-vault/out', 'CryptoVault')
