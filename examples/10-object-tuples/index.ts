/**
 * Example 10: Object Tuples — Deployment & Test Script
 *
...
async function main() {
  printHeader('Example 10 — Object Tuples')

  // Step 1: Compile the contract
  printStep(1, 'Compiling contract...')
  compileContract('10-object-tuples')
  printSuccess('Contract compiled')

  // Step 2: Load app spec
  printStep(2, 'Loading app spec...')
  const appSpec = loadAppSpec('10-object-tuples/out', 'ObjectTuples')
