/**
 * Example 06: Membership Registry — Deployment & Test Script
 *
...
async function main() {
  printHeader('Example 06 — Membership Registry')

  // Step 1: Compile the contract
  printStep(1, 'Compiling contract...')
  compileContract('06-membership-registry')
  printSuccess('Contract compiled')

  // Step 2: Load app spec
  printStep(2, 'Loading app spec...')
  const appSpec = loadAppSpec('06-membership-registry/out', 'MembershipRegistry')
