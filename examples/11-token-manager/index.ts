/**
 * Example 11: Token Manager — Deployment & Test Script
 *
...
async function main() {
  printHeader('Example 11 — Token Manager')

  // Step 1: Compile the contract
  printStep(1, 'Compiling contract...')
  compileContract('11-token-manager')
  printSuccess('Contract compiled')

  // Step 2: Load app spec
  printStep(2, 'Loading app spec...')
  const appSpec = loadAppSpec('11-token-manager/out', 'TokenManager')
