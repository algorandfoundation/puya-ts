...
import { ArrayLiteralPType, ArrayPType, FixedArrayPType, ReferenceArrayType } from '../../../ptypes'
...
export function arrayElementType(arrayType: PType, sourceLocation: SourceLocation) {
  ...
  if (arrayType instanceof FixedArrayPType) return arrayType.elementType
  if (arrayType instanceof ReferenceArrayType) return arrayType.elementType
