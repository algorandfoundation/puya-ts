...
import { ARC4MethodConfig } from './arc4'
...
export class AssignmentStatement extends Statement {
  ...
  target!: VarExpression | FieldExpression | IndexExpression | TupleExpression | AppStateExpression | AppAccountStateExpression
  value!: Expression
  accept<T>(visitor: StatementVisitor<T>): T {
...
export class ForInLoop extends Statement {
  ...
  items!: VarExpression | FieldExpression | IndexExpression | TupleExpression | AppStateExpression | AppAccountStateExpression
  loopBody!: Block
  accept<T>(visitor: StatementVisitor<T>): T {
...
export class StateGet extends Expression {
  ...
  field!: AppStateExpression | AppAccountStateExpression
  default!: Expression
  accept<T>(visitor: ExpressionVisitor<T>): T {
...
export class ContractMethod extends Function {
  ...
  className!: string
  abimethodConfig: ARC4MethodConfig | undefined
  accept<T>(visitor: ModuleStatementVisitor<T>): T {
...
export class AppStateDefinition extends Node {
  constructor(props: Props<AppStateDefinition>) {
    super()
    Object.assign(this, props)
  }
  memberName!: string
...
export class ContractFragment extends ModuleStatement {
  ...
  appState!: Map<string, AppStateDefinition>
  reservedScratchSpace!: Set<bigint>
  stateTotals: StateTotals | undefined
  docstring: string | undefined
  symtable!: Map<string, ContractMethod | AppStateDefinition>
  accept<T>(visitor: ModuleStatementVisitor<T>): T {
...
export const concreteNodes = {
  ...
  appStateDefinition: AppStateDefinition,
