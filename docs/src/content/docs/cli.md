...
| `--output-client`              | Flag                                                       | No (default false)           | Output Algorand TypeScript contract client for typed ARC-4 ABI calls contracts.                                                                                                                                                                                                                                                                                                                                                                              |
...
| `--output-assembly-report`     | Flag                                                       | No (default false)           | Output "human-readable" source map for advanced debugging purposes.                                                                                                                                                                                                                                                                                                                                                                                          |
