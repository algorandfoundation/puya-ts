...
Defined in: [packages/algo-ts/src/op.ts:1521](https://github.com/algorandfoundation/puya-ts/blob/14c9827d80da81ff08b4923e997ba22be04aa0db/packages/algo-ts/src/op.ts#L1521)
...
> **get** **genesisHash**(): [`bytes`](../../../type-aliases/bytes.md)
...
> **get** **payoutsPercent**(): [`uint64`](../../../type-aliases/uint64.md)
