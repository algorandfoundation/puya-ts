...
[@algorandfoundation/algorand-typescript](../../../README.md) / [index](../../README.md) / itxn
...
- [applicationCall](functions/applicationCall.md)
- [assetConfig](functions/assetConfig.md)
- [assetFreeze](functions/assetFreeze.md)
- [assetTransfer](functions/assetTransfer.md)
- [keyRegistration](functions/keyRegistration.md)
- [payment](functions/payment.md)
- [submitGroup](functions/submitGroup.md)
