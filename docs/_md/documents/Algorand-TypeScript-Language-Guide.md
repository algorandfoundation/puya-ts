...
If you are interested in learning about the design of Algorand TypeScript, you can see our [Guiding Principles](documents/Guiding-Principals.md) for more detail including the Architectural Decision Records (ADRs) which got us here.
