...
| `--validate-abi-values`          | Flag                                                       | No (default false)           | Validates ABI transaction arguments by ensuring they are the correct size                                                                                                                                                                                                                                                                                                                                                                                    |
| `--validate-abi-dynamic-severity | Enum (error,info,warning,debug,critical)                   | No (default warning)         | Severity level for unvalidatable dynamic ABI types                                                                                                                                                                                                                                                                                                                                                                                                           |
